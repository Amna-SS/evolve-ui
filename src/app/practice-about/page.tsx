        ...
        <div className="container px-4 md:px-6">
          <div className="mx-auto max-w-3xl text-center space-y-4">
            ...
            <p className="text-xl text-strong-foreground">
              From API to UI — where pixels meet according to the criteria
            </p>
          ...
          <div className="mx-auto max-w-4xl space-y-8">
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  Rabbit lives in a forest with her three godmothers. Little does she know  that her godmothers are fairies.
                </p>
                <p>
